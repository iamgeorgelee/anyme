...
var createGroupsTable = 'CREATE TABLE IF NOT EXISTS ' +
        'groups(' +
        'id SERIAL PRIMARY KEY, ' +
...
var createGroupiesTable = 'CREATE TABLE IF NOT EXISTS ' +
        'groupies(' +
...
client.query(createGroupsTable);
client.query(createGroupiesTable);
